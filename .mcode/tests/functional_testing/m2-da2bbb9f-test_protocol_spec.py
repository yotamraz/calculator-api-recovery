...
Generated at: 2026-02-27T21:56:33.737665+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Create a calculation with the add operation and verify the result is correct",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with the sub operation and verify the result is correct",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation without the operation field, expect 422",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations and verify it returns an array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a calculation, then retrieve it by ID and verify it matches",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
