...
Generated at: 2026-02-23T17:26:36.310731+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two negative numbers to verify correct handling of negative operands",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide by zero to verify HTTP 400 with 'Cannot divide by zero' detail",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide numbers that produce a non-integer fractional result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
