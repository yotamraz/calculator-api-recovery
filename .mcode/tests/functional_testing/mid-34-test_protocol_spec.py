...
Generated at: 2026-02-15T18:46:02.621460+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add with missing required field b, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide by zero, expect 400 error with Cannot divide by zero message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a stored add calculation and verify 201 response with all fields",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
        ...
        "actual_response": {
            ...
            "result": 40.0,
            "id": 1,
            "created_at": "2026-02-15T18:14:08.217379"
        }
    },
    {
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "result": 27.0,
            "id": 2,
            "created_at": "2026-02-15T18:14:08.233690"
        }
    },
    {
