...
Generated at: 2026-02-17T11:54:44.062796+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add negative numbers and verify correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Send string instead of number for operand and expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Send empty body and expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with add operation and verify 201 with all fields returned",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
        ...
        "actual_response": {
            ...
            "result": 40.0,
            "id": 1,
            "created_at": "2026-02-17T09:29:50.907708"
        }
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create calculation with unknown operation and expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create calculation with div operation and b=0, expect 400 Cannot divide by zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a calculation, then retrieve it by ID and verify fields match",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
        ...
        "actual_response": {
            ...
            "result": 27.0,
            "id": 2,
            "created_at": "2026-02-17T09:29:50.929945"
        }
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Request a calculation with a non-existent ID and expect 404",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Delete a calculation with non-existent ID and expect 404",
        "request_data": {
            "path": {
                "calculation_id": 999999
            },
