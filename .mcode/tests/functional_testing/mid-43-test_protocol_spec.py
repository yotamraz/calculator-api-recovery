...
Generated at: 2026-02-15T22:17:57.146545+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns status ok and version fields",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add negative numbers to verify correct arithmetic",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "subtract_with_zero",
        "category": "BOUNDARY",
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract zero from a number to verify identity behavior",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with mul operation and verify response includes id and created_at",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a div calculation with b=0 to verify 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
