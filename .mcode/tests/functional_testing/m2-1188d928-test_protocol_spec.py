...
Generated at: 2026-03-18T22:47:59.877235+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Create a valid addition calculation and verify 201 response with all fields",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a division calculation with b=0 and expect 400 with divide-by-zero error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List calculations on a fresh database and expect an empty array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "list_calculations_with_record",
        "category": "HAPPY_PATH",
        "endpoint": "/calculations",
        "method": "GET",
        "description": "Create a calculation, then list all calculations and verify the record appears",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{id}",
        "method": "GET",
        "description": "Create a calculation, retrieve it by ID, and verify the response matches",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    {
        "name": "get_calculation_by_id_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/calculations/{id}",
        "method": "GET",
