...
Generated at: 2026-03-02T08:46:11.937633+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two positive numbers and verify the sum is correct",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two negative numbers to verify handling of negative operands",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Send string values instead of numbers to verify type validation",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract two numbers and verify the difference is correct",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract a larger number from a smaller one resulting in a negative value",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Send request with missing required field a to verify validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers and verify the product is correct",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply a number by zero to verify the result is zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers and verify the quotient is correct",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide by zero to verify a 400 error is returned with appropriate message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide numbers that produce a fractional result to verify decimal handling",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Send empty body to verify validation error for missing required fields",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns 200 with status ok",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
...
ENDPOINT_ROUTING: dict[str, dict[str, str]] = json.loads(r'''{"POST /calculations": {"base_url": "http://localhost:8000", "endpoint": "/calculations"}, "GET /calculations": {"base_url": "http://localhost:8000", "endpoint": "/calculations"}, "GET /calculations/{calculation_id}": {"base_url": "http://localhost:8000", "endpoint": "/calculations/{calculation_id}"}, "DELETE /calculations/{calculation_id}": {"base_url": "http://localhost:8000", "endpoint": "/calculations/{calculation_id}"}}''')
