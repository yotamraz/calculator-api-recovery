...
Generated at: 2026-02-23T18:26:59.949190+00:00
...
TEST_CASES = json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Create a calculation with the add operation and verify it returns 201 with the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with the mul operation and verify it returns 201 with the correct result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation with an unsupported operation and verify 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a div calculation with b=0 and verify 400 error for division by zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_calculation_missing_required_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation with missing 'operation' field and verify 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "list_calculations_empty",
        "category": "HAPPY_PATH",
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List calculations on a fresh database and verify it returns an empty array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "list_calculations_with_data",
        "category": "HAPPY_PATH",
        "endpoint": "/calculations",
        "method": "GET",
        "description": "Create a calculation, then list all calculations and verify the created record appears",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation, delete it by ID, and verify 204 response",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
