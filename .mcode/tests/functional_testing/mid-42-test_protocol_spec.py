...
Generated at: 2026-02-15T23:03:11.275422+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Omit required field b to verify validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Omit required field a to verify validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide by zero to verify HTTP 400 error response with error message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Omit both required fields to verify validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with add operation and verify 201 response with all fields",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
        ...
        "actual_response": {
            ...
            "result": 10.0,
            "id": 3,
            "created_at": "2026-02-15T22:18:27.540389"
        }
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with an unknown operation to verify HTTP 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a calculation with div operation and b=0 to verify HTTP 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "actual_response": [
            ...
            },
            {
                ...
                "result": 15.0,
                "id": 2,
                "created_at": "2026-02-15T21:09:27.143592"
            },
            {
                "operation": "add",
                "a": 5.0,
                ...
                "result": 8.0,
                "id": 1,
                "created_at": "2026-02-15T21:08:43.154085"
            }
        ]
    },
    {
        ...
        "actual_response": {
            ...
            "result": 42.0,
            "id": 4,
            "created_at": "2026-02-15T22:18:27.552626"
        }
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent calculation to verify 404 response",
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation and then delete it, verify 204 no content",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent calculation to verify 404 response",
        "request_data": {
            "path": {
                "calculation_id": 999999
            },
