...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Add two positive numbers and verify the sum",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Send request with missing required field b to verify validation",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/subtract",
        "method": "POST",
        "description": "Subtract b from a and verify the difference",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply two numbers and verify the product",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "multiply_missing_body",
        "category": "MISSING_REQUIRED",
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Send request with empty body to verify validation",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide two numbers and verify the quotient",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide negative by positive to verify correct signed result",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
