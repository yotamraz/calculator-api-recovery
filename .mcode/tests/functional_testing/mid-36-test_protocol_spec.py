...
Generated at: 2026-02-15T19:58:28.597830+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/multiply",
        "method": "POST",
        "description": "Multiply a number by zero to verify zero result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division by zero, expect 400 error with detail message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "divide_decimal_result",
        "category": "HAPPY_PATH",
        "endpoint": "/divide",
        "method": "POST",
        "description": "Divide numbers that produce a non-integer decimal result",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
