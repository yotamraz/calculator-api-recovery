...
Generated at: 2026-02-15T18:13:11.373444+00:00
...
TEST_CASES = json.loads(r'''[
    ...
    },
    {
        ...
        "endpoint": "/add",
        "method": "POST",
        "description": "Attempt to add with missing 'b' field, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division by zero, expect HTTP 400 error with detail message",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/divide",
        "method": "POST",
        "description": "Attempt division with string value, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a calculation with add operation and verify 201 with result fields",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create calculation with unknown operation, expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create calculation with division by zero, expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "List all calculations and verify 200 status with array response",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to get a non-existent calculation, expect 404",
        "request_data": {
            "path": {
